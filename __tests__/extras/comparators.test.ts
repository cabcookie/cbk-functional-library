...
describe("run date comparision with wrong parameters", () => {
    test("run without a key and with numbers", () => {
        expect(dateComparator()(1,2)).toThrowError()
    })
    test("run without a key and with strings", () => {
        expect(dateComparator()("1","2")).toThrowError()
    })
})

describe("testing date comparision with a key of an object with no order", () => {
...
describe("testing date comparision with a key of an object with ascending order", () => {
    test("compare same dates should return 0", () => {
...
describe("testing date comparision with a key of an object with descending order", () => {
    test("compare same dates should return 0", () => {
...
describe("testing date comparision with a date with no order", () => {
    test("compare same dates should return 0", () => {
...
describe("testing date comparision with a date with ascending order", () => {
    test("compare same dates should return 0", () => {
...
describe("testing date comparision with a date with descending order", () => {
    test("compare same dates should return 0", () => {
